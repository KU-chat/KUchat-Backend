...
public class BlockController {
    ...
    @PostMapping("/{id}")
    public ResponseEntity<BaseResponse> block(@AuthenticationPrincipal Member member,
    ...
    public ResponseEntity<BaseResponse> release(@AuthenticationPrincipal Member member,
    ...
    @GetMapping("")
    public ResponseEntity<BlockMemberResponses> blockMemberList(@AuthenticationPrincipal Member member) {
